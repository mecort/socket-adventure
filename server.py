...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "You are in the room with the large hearth.",
            "You are in the room with the mounted sword.",
            "You are in the room with the shielded crest.",
            "You are in the room with the dragon statue.",
        ][room_number]
